...
parser.add_argument('--model_test', default='testFELI_b', type=str, help='test model name')
parser.add_argument('--model_train', default='trainFELI_b', type=str, help='train model name')
...
def test(test_loader, network, result_dir, lpips_metric):
	PSNR = AverageMeter()
	SSIM = AverageMeter()
	LPIPS = AverageMeter()
